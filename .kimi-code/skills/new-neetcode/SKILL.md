---
name: new-neetcode
description: Prepare a blank, LeetCode-compatible Python exercise from a NeetCode problem URL in this interview-practice repository. Use only when the user explicitly invokes `/skill:new-neetcode` and provides a NeetCode problem link; create the typed `Solution` skeleton without an approach, solution, or tests.
